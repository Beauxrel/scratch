...
The wireshark capture shows a total length of 105 bytes for each UDP packet. 
THis is made up of 102 bytes of data, 8 bytes of UDP header, 20 bytes of IP header, and 7 bytes of PPP header.
